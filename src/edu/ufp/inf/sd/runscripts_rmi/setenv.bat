...
@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:\Programas\Java\jdk-11.0.9
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\Desktop\\Universidade\\Sistemas Distribuidos\\PL\\%JAVAPROJ_NAME%
...
@Set PRODUCER_CLASS_PREFIX=EmitLogs
